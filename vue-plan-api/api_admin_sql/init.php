...
$webInfo=array(
    ...
    'bulletinShow'=>$admin_site_bulletinShow,
...
function createAdminLimitTable($servername, $username, $password, $dbname)
{
    ...
    $sql = "CREATE TABLE adminLimit (
        ...
        webSetting_siteConfig INT NOT NULL,
        ...
        webSetting_bulletinShow INT NOT NULL,
