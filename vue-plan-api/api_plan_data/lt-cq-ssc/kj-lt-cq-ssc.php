...
class vrsxffc
{
    ...
    public function __construct()
    {
        ...
        $this->kjInterval = 20*60;//每期20分钟  59期
        $this->loopInterval = 2;
        $this->oneMID=5;//0-9  小于5的为小
        $this->sumMID=23;// 5位数，0~9，和值为0~45，小值为0-22   小于23的为小

        ////开奖时间，	0:30:00~~03:10:00  7:30:00~23:50:00    (实际在0:32:00左右抓到数据)
        ////计划于00:31:10进入访问，下方的开奖时间要比计划任务设定的早一点
        $this->nowTime=strtotime(date("Y-m-d H:i:s"));
        $this->kjTime=strtotime(date("Y-m-d")." 00:30:00");
        ...
        $this->api = 'https://www.ezun889.com/lottery/commonLottery/getRecent5Records.html?code=cqssc';
        if ($isLuck) {
            $this->api = 'https://luck.sdtiop.com/hall/pc/lottery/get-recent-close-expect.html?code=cqssc';
        }
