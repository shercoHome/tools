...
class vrsxffc
{
    ...
    public function __construct()
    {
        ...
        $this->kjTime=strtotime(date("Y-m-d")." 00:04:50");//	13:09:51
        $this->jsTime=strtotime(date("Y-m-d")." 00:04:49");

        $this->cookiePath=$dir."/cookie.txt";
        if ($isLuck) {
            $this->cookiePath=$dir."/cookieIsLuck.txt";
        }
        $this->api = 'https://www.ezun889.com/lottery/commonLottery/getRecent5Records.html?code=wfpk10';
        if ($isLuck) {
            $this->api = 'https://luck.sdtiop.com/hall/pc/lottery/get-recent-close-expect.html?code=wfpk10';
        }
