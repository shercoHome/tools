...
$str='[{"name":"定位胆","item":[{"name":"冠","item":[{"name":"四码","item":4},{"name":"五码","item":5},{"name":"六码","item":6},{"name":"七码","item":7}]},{"name":"亚","item":[{"name":"四码","item":4},{"name":"五码","item":5},{"name":"六码","item":6},{"name":"七码","item":7}]},{"name":"季 ","item":[{"name":"四码","item":4},{"name":"五码","item":5},{"name":"六码","item":6},{"name":"七码","item":7}]}]},{"name":"大小定位","item":[{"name":"冠","item":[{"name":"一码","item":1}]},{"name":"亚","item":[{"name":"一码","item":1}]},{"name":"季","item":[{"name":"一码","item":1}]}]},{"name":"单双定位","item":[{"name":"冠","item":[{"name":"一码","item":1}]},{"name":"亚","item":[{"name":"一码","item":1}]},{"name":"季","item":[{"name":"一码","item":1}]}]},{"name":"冠亚和","item":[{"name":"大小","item":[{"name":"一码","item":1}]},{"name":"单双","item":[{"name":"一码","item":1}]},{"name":"大小单双","item":[{"name":"一码","item":1}]}]}]';
...
$oneMID=6;//1-10  小于6的为小
$sumMID=12;// 和值为3-19   小于12的为小
        ...
        for ($x2=0;$x2<$len2;$x2++) { //10个定位
            ...
            for ($x3=0;$x3<$len3;$x3++) {//码
                ...
                for ($q=1;$q<=$one_day_all_qi;$q++) {//一天一共179期
                    ...
                    $random_sum=mt_rand(3, 19);//"冠亚和"
                    $random_one=mt_rand(1, 10);
                    switch ($arr[$x1]->name) {
                        case "定位胆":
                            //数组乱序
                            shuffle($pk10_ar);
