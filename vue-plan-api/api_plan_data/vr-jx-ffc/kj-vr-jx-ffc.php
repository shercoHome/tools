...
class vrsxffc
{
    ...
    {
        $isPOST=true;
        $isLuck=false;//幸运彩票 true   龙头彩票 false

        $isTEST=false;

        $dir= dirname(__FILE__);

        $this->kjInterval = 1.5*60;//每期1.5分钟  840期
        $this->loopInterval = 2;
        ...
        $this->kjTime=strtotime(date("Y-m-d")." 09:02:00");
        ...
        $this->cookieStr="ASP.NET_SessionId=libb2mgsa0w10es0pswljwro; __RequestVerificationToken=zvopn-bPP9qmRWmnhUXpsh_Xj5X-qxvVwjh2q608p7li3jzB1b7zuYwUBeSBl_NvhiPmU6qY6bOzFY9ftGKJ-DIZa5L9fgMX11HA3Bw1zMc1; token=e02a3349f31ec4ae5c007da28893b068; random=1446; .AspNet.ApplicationCookie=D4TxvJPNvOM0KOYVDeKRhagyHSDxOVg0rA26lWsaeI2q-sIlvLcLgus_yVeLQQJaxhUZv5i1Kf4T361av81Vn4uXm5Ukvp6cF0CYjOONfAKGhUliTuxHGbhxH16jSfIBshmgU8qoPUIHTlD9l3w5DrVnya6Cl6RI_2IGqey3TugZlYSc8QLuMW89GX8vrByRV2iucmkCmayGvekOePuO44UBdlnCcbsj2Y2JX7VJaar5USP4mMo1Sd_tgovIccxjxtjkNHm-eECY7-IcdSzJ7GUitFVceiTd32cfOWI0oIOIEHeBpVuKwk2gDHvRd0g3MZy-lLDrzVOL-_bDde9gBr-9dvc9Vr-b8SHSa6iUd4KCM0V1Qp7By0OUaGFUKx_Uqy1B-NcEcQIMpgqDwmdNHiZoQSAC65UpsKFRmTo0mqTp0YKbJJ5tdip0ALQxqnPHhYqLJCBlNrWVqjGoIW3tRdAOmHdbOph5fYsj6yKefazuq0WD5NVtNczMk50SeTPXE-x437bD3cRW-arj8qEBqy6uPXVO9ro2wHmO2Pd9UOE";
